...
- Collaboratively remotely edit files
- Change management
- Capture content as a "list of changes"
...
- *Refer to tickets from the code and commit message* -- GitHub detects ticket references (i.e. `#4711`) and links them from the tickets. It even supports keywords like `fixes` to automatically resolve a ticket when pushing the commit.
