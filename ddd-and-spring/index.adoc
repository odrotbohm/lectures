...
In other words, while you might be familiar with more technical patterns already, in business code they're mostly perceived as technical noisefootnoteref:[patterns-as-technical-noise, Patterns as technical noise - https://www.slideshare.net/cyriux/ddd-patterns-that-were-not-in-the-book[Slide deck, slide 54]].
Also, the original authors of the GoF book have shared incisive insightsfootnoteref:[gof-interview, Design Patterns 15 Years Later: An Interview with Erich Gamma, Richard Helm, and Ralph Johnson,  http://www.informit.com/articles/article.aspx?p=1404056[Interview]] about what they'd do differently if the book ever got an update, including which patterns to deemphasize, how to slightly change the organization of the patterns etc.
