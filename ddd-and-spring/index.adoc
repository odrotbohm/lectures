...
Implementing model elements as value objects also has a great impact on legibility and comprehensibility of the code base as Dan Bergh Johnsonsson demonstrates in his talk Power Use of Value Objects in DDD <<power-of-value-objects>>.
